...
public class ClienteRepositoryImpl implements ClienteHelper {
	...
	public Page<Cliente> filtrar(ClienteFilter  clienteFilter, Pageable pageable) {
		...
		Predicate[] predicates = criarRestrincoes(clienteFilter, builder, root);
	...
	private Predicate[] criarRestrincoes(ClienteFilter  clienteFilter, CriteriaBuilder builder, Root<Cliente> root) {
		List<Predicate> predicates = new ArrayList<Predicate>();

		if (clienteFilter != null) {
			
                      if (clienteFilter.getId() != null) {
				predicates.add(builder.equal(root.get("id"), clienteFilter.getId()));
			}
